...
public class ConnectToServices : MonoBehaviourPunCallbacks
{
    ...
    public override void OnJoinedRoom()
    {
        ...
        {
            GameObject playerListItem = Instantiate(_playerListing, _playerListContent.transform);
    ...
    public override void OnCreateRoomFailed(short returnCode, string message)
    {
         ...
         */
        _canvasManager.ShowError(returnCode.ToString() + " " + message);
    }
    ...
    public override void OnRoomListUpdate(List<RoomInfo> roomList)
    {
         ...
         * 
         */
        foreach (Transform transform in _roomListContent.transform)
        {
            Destroy(transform.gameObject);
        }
        foreach (RoomInfo room in roomList)
        {
            ...
            {
                GameObject roomListing = Instantiate(_roomListing, _roomListContent.transform);
                roomListing.GetComponent<ListItem>().SetUp(room);
            }            
        }
    }
